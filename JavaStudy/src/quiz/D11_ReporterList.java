...
public class D11_ReporterList {
	...
	*/
	...
	public static void main(String[] args) {
		...
		Pattern reporterPattern = Pattern.compile("\\W+\\S+\\S(\\w+@)(\\w+\\.\\w+\\.\\w+)");
		Matcher emailMatcher = emailPattern.matcher(reporters);
...
//			System.out.println(reporterMatcher.group());
			
		}
		
//		for (int i = 0; i < emailList.size(); ++i) {			
//			domain = emailList.get(i);
//			cnt = Collections.frequency(emailList, emailList.get(i));
//			for (int j = 0; j < i; ++j) {
//				String domain2 = emailList.get(j);
