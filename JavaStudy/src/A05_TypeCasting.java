...
public class A05_TypeCasting {
	...
	/*
		...
		byte < short, char //범위는 같지만 양수냐 음수냐 < int < long(8) < float(4) < double
	...
	*/
	...
	public static void main(String[] args) {
		...
		// short에 char값을 넣을때는 32767을 초과하는 양수가 존재할 위험이 있다
		// snum = (short)ch1;
		...
		short sss = -1;
		char ccc = (char)sss;
		System.out.println("결과는:" + (int)ccc);
		...
		// ex> 123.123345 에서 5를 반올림하고 싶은 경 우
		...
		System.out.println("달러: " + 7.26565626 * 100);
		System.out.println("달러: " + Math.round(7.26565626 * 100));
		System.out.println("달러: " + Math.round(7.26565626 * 100) / 100.0);
