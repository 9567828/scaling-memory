...
public class C05_ReferencesType {
	...
	*/
	...
	// 참조형 타입 배열의 경우
	public static void referecesType1(double[] arr) {
	...
	// 내가 만든 클래스인 경우
	public static void referecesType2(Book book) {
		book.page = 121;
	}
	
	// 문자열의 경우
	public static void referecesType3(String str) {
		str = "Babo";
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("클래스인스턴스의 before: " + c.page);
		referecesType2(c);
		System.out.println("클래스인스턴스의 After: " + c.page);
		
		
		// String은 예외적으로 기본형 처럼 동작하게 구현되어 있는 참조형
